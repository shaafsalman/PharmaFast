-- Create User Authentication tables with auto-increment primary key
CREATE TABLE Users (
...
-- Create Product Catalog tables and merge with Expiry Date
...
-- Sample data for TransactionItems
